...
export declare function asBigint(x: Complex | BigDecimal | ExpressionInput | undefined): bigint | null;
export declare function asBignum(expr: Expression | undefined): BigDecimal | null;
/**
