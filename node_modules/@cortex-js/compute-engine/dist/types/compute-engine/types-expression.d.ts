...
export interface Expression {
     ...
     *
     */
    match(pattern: string | ExpressionInput, options?: PatternMatchOptions<Expression>): BoxedSubstitution<Expression> | null;
    /**
     *
